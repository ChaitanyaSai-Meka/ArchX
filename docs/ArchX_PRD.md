...
We create many diagrams (Ex: Class,Sequence ,ERD etc) while try developing a system architecure and with every new entity or relationships we have to draw and update the existing diagram manually which is such a tiem taking process.

Here we are with ArchX  and its AI powered tool  to build a your diagrams in seconds to create actuall diagrams or blueprint of your system architecture. by understanding your requirements we will generate and update the diagrams for you. 

Or create boiler plate structure where you can edit the diagrams manually aas per you proejct liking or requirements and techstacks
...
To create a specilaized AI tool or agent to create necessary or boiler plate structures for a porejcts according to its requirements and techstacks 
and editor to edit the generated ones ( by the chances of hallucination or incrooect or misleading context)  to save valuable time of developers and architects and tokens 
...
1. Converst user gvien text or prompt into structural diagrams for a porejct for system design as per the requiremts for the system or porject and techstacks .

2. allow user to edit the generated diagrams as per the requiremts and save  the created structure.

3. modifying the existing diagrmas for any new requrements instead of creating new diagrams to save cntext or llm's tokens 


## Tech Stacks (yet ot be decided)
